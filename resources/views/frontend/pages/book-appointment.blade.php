					...
					<div class="row">
						<div class="col-12">
								...
								<div class="card-body">
									<div class="booking-doc-info">
										<a href="doctor-profile.html" class="booking-doc-img">
											<img src="{{ asset('frontend/images/doctors/doctor-thumb-02.jpg') }}" alt="User Image">
										</a>
							...
							<div class="submit-section proceed-btn text-right">
								<a href="{{route('appointments.checkout')}}" class="btn btn-primary submit-btn">Proceed to Pay</a>
							</div>
							<!-- /Submit Section -->
