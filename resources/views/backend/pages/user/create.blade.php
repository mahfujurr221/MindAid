            ...
            <div class="mt-3 row">
                ...
                <div class="mb-2 col-md-4">
                    ...
                    <select name="type" class="form-select {{ $errors->has('type') ? 'is-invalid' : '' }}"
                        data-placeholder="Select User Type" required>
                        <option value="">Select User Type</option>
                        <option {{ old('type')=='user' ? 'selected' : '' }} value="doctor">Doctor</option>
                        <option {{ old('type')=='patient' ? 'selected' : '' }} value="patient">Patient</option>
                ...
                <div class="mb-2 col-md-4">
                    ...
                    <select name="role" class="form-select {{ $errors->has('role') ? 'is-invalid' : '' }} select2"
