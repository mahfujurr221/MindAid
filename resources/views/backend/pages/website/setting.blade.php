    ...
    <div class="row">
        <div class="col-lg-7 col-xl-9">
            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-5 col-md-6">
                                        <label for="validationCustom05" class="form-label font-weight-bold">
                                            Website Logo</label>
                                        <input class="mr-5 form-control" id="validationCustom05" type="file"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input class="mr-5 form-control" id="validationCustom06" type="file"
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom08"
                                            name="footer_text" value="{{ $setting->footer_text }}">
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <textarea class="form-control" id="validationCustom03" rows="5" name="address">{{ $setting->address }}</textarea>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom10"
                                            name="twitter" value="{{ $setting->twitter }}" placeholder="without +88 ">
                                    </div>
                                    <div class="mb-3 col-md-12">
                            ...
                            <form action="{{ route('settings.update', $setting->id) }}" method="POST">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <textarea class="form-control" id="validationCustom17" rows="5" placeholder="Enter Meta Description"
                ...
                {{-- Google Map API --}}
                <div class="tab-pane fade" id="v-pills-google-map" role="tabpanel"
                    aria-labelledby="v-pills-google-map-tab">
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="mb-0 card-title">Google Map API</h5>
                        </div>
                        <div class="my-3 card-body">
                            <form action="{{ route('settings.update', $setting->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="form-row">
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom15"
                                            name="google_maps_api_key" value="{{ env('GOOGLE_MAPS_API_KEY') }}">
                                    </div>
                                </div>
                                <div class="mt-3 text-center col-md-12">
                                    <button type="submit" class="btn btn-primary font-16">
            ...
            <div class="card m-b-30">
                ...
                <div class="py-3 card-body">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="mb-2 nav-link" id="v-pills-seo-tab" data-toggle="pill" href="#v-pills-seo"
