                ...
                <tr class="text-center">
                    ...
                    <td>
                        <form action="{{ route('appointments.update-status', $data->id) }}" method="POST">
                            ...
                            <button class="btn btn-outline-primary btn-sm" {{ $data->status == 3 ||$data->status == 2 || $data->payment_status != 1 ? 'disabled' : ''}}
                    ...
                    <td>
                        <button 
                            ...
                            {{ $data->status == 3 ||$data->status == 2 || $data->payment_status != 1 ? 'disabled' : ''}} 
